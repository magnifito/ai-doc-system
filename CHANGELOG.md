...
- Skill descriptions are under 400 characters and say only when to use the skill. Claude Code
  listed four of the five plugin skills with no description at all once theirs passed roughly 500
  characters, and a skill with no description is one an agent cannot choose. The test now caps
  the length.
